...
class Crypto(commands.Cog):
    ...
    async def bitcoin(self, ctx):
      ...
      url='https://media.discordapp.net/attachments/835071270117834773/844223345776263239/btc_logo.png')
        btcembed.set_footer(text="Courtesy of the CoinGecko API")
    ...
    async def ethereum(self, ctx):
        ...
        ethembed.set_footer(text="Courtesy of the CoinGecko API")
    ...
    async def dogecoin(self, ctx):
        ...
        dogeembed.set_footer(text="Courtesy of the CoinGecko API")
    ...
    async def cardano(self, ctx):
        ...
        adaembed.add_field(name='Price', value=f'{adaprice:,} USD', inline=False)
        ...
        adaembed.set_footer(text="Courtesy of the CoinGecko API")
        adaembed.set_thumbnail(url='https://media.discordapp.net/attachments/835071270117834773/844227147806933012/cardano-ada-logo-1024x1024.png')
    ...
    async def basicattentiontoken(self, ctx):
        ...
        batembed.set_footer(text="Courtesy of the CoinGecko API")
        batembed.set_thumbnail(url='https://media.discordapp.net/attachments/835071270117834773/844230107140325416/BAT.png')
